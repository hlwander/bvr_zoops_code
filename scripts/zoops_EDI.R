...
zoopdens19 <- read.csv('zoop_data/FCR2019_ZooplanktonCounting_Density_DataEntry.csv',header = TRUE)
zoopdens20 <- read.csv('zoop_data/FCR2020_ZooplanktonCounting_Density_DataEntry.csv',header = TRUE)
zoopdens21 <- read.csv('zoop_data/FCR2021_ZooplanktonCounting_Density_DataEntry.csv',header = TRUE)
...
#read in density csv from all 3 years
zoopbiom19 <- read.csv('zoop_data/FCR2019_ZooplanktonCounting_SizeID_DataEntry.csv',header = TRUE)
zoopbiom20 <- read.csv('zoop_data/FCR2020_ZooplanktonCounting_SizeID_DataEntry.csv',header = TRUE)
zoopbiom21 <- read.csv('zoop_data/FCR2021_ZooplanktonCounting_SizeID_DataEntry.csv',header = TRUE)
